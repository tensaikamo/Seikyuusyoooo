...
function invoiceNoOf(reports,batch,y,m){
  // 個別・一括とも年次連番。同月の再発行や文字だけの従業員IDでも衝突しない。
...
$('import-btn').addEventListener('click',()=>{
  ...
  inp.addEventListener('change',async()=>{
    ...
    try{
      ...
      await idbSetMany([['employees',o.employees],['records',o.records],['settings',settings],['invoiceLog',o.invoiceLog],['ready',true]]);
      STATE.employees=o.employees;STATE.records=o.records;STATE.settings=settings;STATE.invoiceLog=o.invoiceLog;STATE.ready=true;invalidateIdx();
