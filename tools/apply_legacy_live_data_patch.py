...
# v1.6.2 introduced calculation-side caps while explicitly keeping old raw values so
# users could identify and repair them. A schema-less backup may therefore legitimately
# contain those pre-cap raw values. Preserve them only for old backups; schemaVersion=1
# remains strict.
